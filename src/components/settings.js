  ...
  function SettingsView({ categories, setCategories, categoryColors = {}, setCategoryColors = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "cf-page" }, /* @__PURE__ */ React.createElement("div", { className: "settings-toprow" }, /* @__PURE__ */ React.createElement("div", {
      ...
      label
    ))), /* @__PURE__ */ React.createElement(Card, { id: "sec-ai-key", className: "mb-20" }, /* @__PURE__ */ React.createElement(SectionTitle, null, "AI Insights \u2014 Anthropic API Key"), /* @__PURE__ */ React.createElement("div", { className: "txl lh-15 mb-12" }, "Powers the AI features: the yearly assessment, receipt scanning, CSV categorisation and natural-language entry capture. The key is stored on this device only \u2014 it is deliberately never synced to Supabase or shared with household members, because it bills your account, so enter it again on each device you use. Anyone able to run script in this page could read it, same as any other browser-side API key. To avoid holding a key in the browser at all, deploy the ai-proxy Edge Function (see the README) \u2014 the app prefers it automatically when it's available. Get a key at", " ", /* @__PURE__ */ React.createElement(
      "a",
      {
