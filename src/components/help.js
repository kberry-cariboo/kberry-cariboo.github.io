  ...
  const HELP_SECTIONS = [
    ...
    },
    {
      ...
      blocks: [
        ...
        { p: "Holidays are British Columbia's, including the two the province lists as optional (Easter Monday and Boxing Day). Settings → Statutory Holidays shows exactly which dates the app is using for a year and lets you add, edit or remove them; nothing is fetched on its own, so a date you correct stays corrected. Moving an occurrence yourself — dragging the row, or Edit this occurrence — re-checks the deposit date from wherever you put it." },
